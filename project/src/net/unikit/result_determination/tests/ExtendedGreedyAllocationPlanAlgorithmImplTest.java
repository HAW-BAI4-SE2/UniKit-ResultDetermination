...
import net.unikit.result_determination.models.implementations.algorithms.ExtendedGreedyAllocationPlanAlgorithmImpl;
 ...
 */
public class ExtendedGreedyAllocationPlanAlgorithmImplTest {
    ...
    public void testCalculateAllocationPlan() throws Exception {
        ...
        AllocationPlanAlgorithm allocPlanAlgorithm = new ExtendedGreedyAllocationPlanAlgorithmImpl(settings);
